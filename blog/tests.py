...
class BlogTestCase(TestCase): # this is called a canary test which is a minimal test that quickly verify that the system works as expected
...
class PageListViewTests(TestCase):
    def test_mutliple_pages(self):
        # Make some test data to be displayed on the page.
        user = User.objects.create() # .create() will create AN save a user 
        ...
        # Integration Tests can check more than one thing
