...
class Page(models.Model):
    ...
    title = models.CharField(max_length=settings.BLOG_POST_TITLE_MAX_LENGTH, unique=True,
                             help_text="Title of your page.")
    author = models.ForeignKey(User, on_delete=models.PROTECT,
                               help_text="The user that posted this article.")
    slug = models.CharField(max_length=settings.BLOG_POST_TITLE_MAX_LENGTH, blank=True, editable=False,
